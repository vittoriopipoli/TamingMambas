...
job_name="SynapseAbdomen_MultiSegMamba_0"
...
echo "nnUNetv2_predict -i data/nnUNet_raw/Dataset090_SynapseAbdomen/imagesTs -o data/nnUNet_raw/Dataset090_SynapseAbdomen/inferTs/0/ -d 90 -tr nnUNetTrainerMultiSegMamba -c 3d_fullres -f 0 --verbose" >> $sbatch_file
